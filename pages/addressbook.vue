                    ...
                    <div class="col-lg-9">
                        <div class="dashboard-body">
                            <div class="profile-address-book">
                                ...
                                <ul class="address-list">
                                    <li class="active">
                                        ...
                                        <div class="address-text">
                                            <h6>Office</h6>
                                            <p class="address">2548 Broaddus Maple Court Avenue, Madisonville KY 4783,
                                                United States of America</p>
                                            <p class="country">America</p>
                                        </div>
                                        <div class="edit-delete-btn">
                                            <button class="edit" type="button" data-toggle="modal"
                                                data-target="#address-edit"><i class="fas fa-edit"></i></button>
                                ...
                                <li class="addnew">
                                    <button type="button" data-toggle="modal" data-target="#address-add"
                                        class="add-new-btn">Add New Address</button>
                                </li>
                            </ul>
                        </div>
                    </div>
